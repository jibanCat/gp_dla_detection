...
catalog = load(sprintf('%s/zqso_smallz_catalog', processed_directory(release)));
...
variables_to_load = {'all_wavelengths', 'all_flux', 'all_noise_variance', ...
    'all_pixel_mask'};
load(sprintf('%s/preloaded_zqso_smallz_qsos', processed_directory(release)), ...
    variables_to_load{:});
...
filename = sprintf('%s/processed_zqso_smallz_qsos_%s-%s_%d-%d_%d-%d_outdata_normout_oc%d', ...
